...
class TalkListGetEmpty(TestCase):
    def test_get_empty(self):
        respose = self.client.get(r('talk_list'))

        self.assertContains(respose, 'Ainda não existem palestras de manhã.')
        self.assertContains(respose, 'Ainda não existem palestras de tarde.')